...
const AddItemPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Calculate auction end time based on duration (hours)
      const endsAt = new Date(Date.now() + form.duration * 60 * 60 * 1000);
  ...
  const fields = [
    ...
    { key: "startPrice", label: "Starting Price (inr)", placeholder: "500", type: "number" },
    { key: "reservePrice", label: "Reserve Price (inr)", placeholder: "2000", type: "number" },
  ];
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "40px 32px 80px" }}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p style={{ color: "var(--text-secondary)", marginBottom: 40 }}>
            Your item will be broadcast to all active bidders in real-time.
          </p>
          <div className="glass-strong" style={{ borderRadius: 24, padding: 32 }}>
              ...
              <div key={f.key} style={{ marginBottom: 20 }}>
                ...
                {errors[f.key] && (
                  <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    style={{ color: "#FB7185", fontSize: 12, marginTop: 5 }}
                  >
                    {errors[f.key]}
                  </motion.p>
                )}
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              />
              {errors.description && (
                <p style={{ color: "#FB7185", fontSize: 12, marginTop: 5 }}>
                  {errors.description}
                </p>
              )}
            </div>
            ...
            {errors.submit && (
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                style={{ color: "#FB7185", fontSize: 13, marginBottom: 16, textAlign: "center" }}
              >
                {errors.submit}
              </motion.p>
            )}
            ...
            <motion.button
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, rgba(167,139,250,0.25), rgba(45,212,191,0.15))",
